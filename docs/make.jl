...
using Literate
 ...
 for filename in readdir("src/Julia_src_files")
     if endswith(filename, ".jl")
         Literate.markdown("./src/Julia_src_files/" * filename, "src/generated_markdowns", documenter = true)
     end
 end
...
for filename in readdir("src/tutorials")
    if endswith(filename, ".jl")
        Literate.markdown("./src/tutorials/" * filename, "src/generated_markdowns", documenter = true)
    end
end
...
makedocs(;
    ...
    pages =[ "Introduction to Hierarchical Gaussian Filtering" => "./generated_markdowns/introduction.md",
        "Theory" => ["./theory/genmodel.md",
                            "./theory/node.md",
                            "./theory/vape.md",
                            "./theory/vope.md"],
            "Tutorials"=> ["classic binary" => "./generated_markdowns/classic_binary.md", 
                        "classic continouous"=>"./generated_markdowns/classic_usdchf.md"],

            "Using the package"=>["The HGF Nodes"=>"./generated_markdowns/the_HGF_nodes.md",
