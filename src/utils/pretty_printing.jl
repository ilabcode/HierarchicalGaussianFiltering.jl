function Base.show(io::IO, hgf::HGF)
    ...
    n_input_nodes = n_continuous_input_nodes + n_binary_input_nodes + n_categorical_input_nodes
    ...
    n_state_nodes = n_continuous_state_nodes + n_binary_state_nodes + n_categorical_state_nodes
    ...
    println("($n_continuous_input_nodes continuous, $n_binary_input_nodes binary and $n_categorical_input_nodes categorical)")

    #State nodes
    println("Number of state nodes: $n_state_nodes")
    println("($n_continuous_state_nodes continuous, $n_binary_state_nodes binary, and $n_categorical_state_nodes categorical)")
