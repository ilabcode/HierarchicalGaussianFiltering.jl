...
function premade_HGF(model_name::String, params_list = (;), starting_state_list = (;))
    ...
    #what name?
    elseif model_name == "2level"
        standard_2level(params_list, starting_state_list)
...
function standard_2level(params_list = (;), starting_state_list = (;))
    input_nodes =
        [(name = "u", params = (; evolution_rate = params_list.evolution_rate_u))]
    state_nodes = [
        (
            name = "x_1",
            params = (; evolution_rate = params_list.evolution_rate_1),
    ...
    child_parent_relations = [
        (
            child_node = "u",
            value_parents = Dict("x_1" => params_list.coupling_1_u),
            volatility_parents = Dict(),
        ),
        (
            child_node = "x_1",
            value_parents = Dict(),
            volatility_parents = Dict("x_2" => params_list.coupling_2_1),
        ),
    ]
    default_params = (
        params = (; evolution_rate = 3),
